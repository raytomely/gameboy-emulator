...
{
    SDL_Surface *screen = NULL, *display_surface = NULL;
    ...
    load_rom(&cpu, "dmg_boot.bin"); cpu.pc=0x0;
    load_nintindo_logo(&cpu);

    int old_time = 0,  actual_time = 0, run_emulation = 1;
    ...
    while(run_emulation)
    {
        ...
        //draw_frame(&cpu, display_surface);
